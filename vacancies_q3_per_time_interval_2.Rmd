...
vacancies_exp_sem <- IDEA_teacher_data
 ...
 scale_fill_idea(reverse = FALSE) +
  ...
  labs(
    #x= "Number of Staffing Vacancies",
      y ="Number of Vacancies",
       title = "Number of Vacancies by Subject",
       subtitle = "by Semester for SY 23-24") +
  
  #add annotation
  annotate("text", x= 0.65, y= 251, label = "ELA") +
  annotate("text", x = 0.65, y = 160, label = "Math") +
  annotate("text", x= 0.65, y= 114, label = "Social Studies") +
  annotate("text", x = 0.65, y = 83, label = "Science") +
  
 annotate("text", x= 0.95, y= 251, label = "246") +
  annotate("text", x = 0.95, y = 160, label = "155") +
  annotate("text", x= 0.95, y= 114, label = "109") +
  annotate("text", x = 0.95, y = 83, label = "78") +

 annotate("text", x= 2.05, y= 73, label = "78") +
  annotate("text", x = 2.05, y = 49, label = "44") +
  annotate("text", x= 2.05, y= 38, label = "40") +
  annotate("text", x = 2.05, y = 25, label = "32") 
